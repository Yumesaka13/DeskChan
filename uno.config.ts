...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'fluent-btn-accent': 'px-3 py-1.5 rounded text-sm border border-transparent text-white bg-brand-primary hover:bg-brand-primary/90 active:bg-brand-primary/80 transition-colors',
